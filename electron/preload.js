...
contextBridge.exposeInMainWorld("pos", {
  ...
  listExpenseCategories: () => invoke("pos:expenses:categories"),
  saveExpense: (payload) => invoke("pos:expenses:save", payload),
  deleteExpense: (id) => invoke("pos:expenses:delete", id),
  getCashBook: (args) => invoke("pos:books:cashBook", args),
  getGeneralLedger: (args) => invoke("pos:books:ledger", args),
  getAccountsBalances: () => invoke("pos:books:accounts"),
  getAnalysis: (args) => invoke("pos:analysis", args),
