...
contextBridge.exposeInMainWorld("pos", {
  ...
  deleteSupplierPayment: (id) => invoke("pos:suppliers:deletePayment", id),
  getCustomerHistory: (id) => invoke("pos:customers:history", id),
  saveCustomerPayment: (payload) => invoke("pos:customers:payment", payload),
  deleteCustomerPayment: (id) => invoke("pos:customers:deletePayment", id),
  saveWithdrawal: (payload) => invoke("pos:customers:withdrawal", payload),
  deleteCustomerWithdrawal: (id) => invoke("pos:customers:deleteWithdrawal", id),
  ...
  getSettings: () => invoke("pos:settings:get"),
  saveSetting: (payload) => invoke("pos:settings:save", payload),
  saveSettings: (payload) => invoke("pos:settings:save_all", payload),
